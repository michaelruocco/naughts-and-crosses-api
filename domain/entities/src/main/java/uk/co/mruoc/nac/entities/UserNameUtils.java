...
public class UserNameUtils {
  ...
  public static UserName tryPopulateAll(UserName name) {
    if (name.hasFirstAndLastName()) {
      return UserNameUtils.toUserName(name.getFirst(), name.getLast());
    }
    if (name.hasFullName()) {
      return UserNameUtils.toUserName(name.getFull());
    }
    if (name.hasFirstName()) {
      return UserNameUtils.firstNameToUserName(name.getFirst());
    }
    if (name.hasLastName()) {
      return UserNameUtils.lastNameToUserName(name.getLast());
    }
    return name;
  }
